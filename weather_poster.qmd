...
format:
  poster-typst: 
    ...
    footer-emails: "team_violet_red@singaporetech.edu.sg"
execute:
  echo: false
knitr:
  opts_chunk:
...
*   The Meteorological Service Singapore and data.gov.sg provide detailed weather statistics and real-time weather readings across Singapore, which can be accessed and used to replicate the visualization we are interested in[^climate_historical_daily_2024].
